 ...
 *
 */
public class FackUserAgentUtil {
    public static JSONObject userAgent;
    ...
    private static  String[] internetexplorer={"Mozilla/5.0 (Windows NT 6.1; WOW64; Trident/7.0; AS; rv:11.0) like Gecko",
    ...
    public static String getUserAgent(){
        //1-740 chrome  741-788 internetexplorer 789-938 firefox  939-984 safari
        int rnum = new Random().nextInt(984)+1;
        int i=new Random().nextInt(50);//0-49
        if(rnum>=1&&rnum<=740){
            //chrome  50
            return chrome[i];
        }else if(rnum>=741&&rnum<=788){
            //internetexplorer  50
            return internetexplorer[i];
        }else if(rnum>=789&&rnum<=938){
            //firefox
            return firefox[i];
        }else if(rnum>=939&&rnum<=984){
            //safari
            return  safari[i];
        }else{
            return chrome[i];
